              ...
              <div class="col-md-6">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control required" id="user_name" name="user_name" placeholder="Enter Username" value="<?php echo ( isset( $user_name ) ) ? $user_name : ''; ?>" disabled>
                  </div>
                  <div class="form-group">
                    <label for="password">Password</label>
                    <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password">
                    <p class="help-block">If you do not want to change the password, please leave this field blank.</p>
                  </div>
                  <div class="form-group">
